# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-05-02 21:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('network', models.CharField(help_text='Insert one ip address or a network mask (i.e. 10.1.1.0/24) to include a whole network.', max_length=18, verbose_name='IP network')),
            ],
            options={
